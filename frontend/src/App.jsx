  ...
  if (appView === 'dashboard') {
    return (
      <DashboardHome
        ...
        onManageRooms={() => { setReturnView('dashboard'); setAppView('manage-rooms'); }}
  ...
  if (appView === 'manage-rooms') {
    return (
      <ManageRoomsPage
        ...
        onContinue={() => setAppView(returnView || 'dashboard')}
        continueLabel={returnView === 'builder' ? 'Continue TT Generation →' : 'Return to Dashboard →'}
      />
    );
  }
        ...
        <main className={styles.main}>
          {activePage === 'constraints' && (
            <ConstraintsPage
              ...
              onUpdateRoom={handleUpdateRoom}
              onDeleteRoom={handleDeleteRoom}
              onOpenManageRooms={() => { setReturnView('builder'); setAppView('manage-rooms'); }}
              onNext={goNext}
            />
          )}
          {activePage === 'setup' && (
