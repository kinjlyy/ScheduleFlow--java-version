        ...
        <div className={styles.content}>
          ...
          <div className={styles.action_grid}>
            ...
            <div className={styles.action_card} onClick={onManageRooms}>
              <div className={styles.action_icon_wrap} style={{background:'#e0f2fe'}}>
                <span className={styles.action_icon}>🏢</span>
              </div>
              <h2 className={styles.action_title}>Manage Rooms</h2>
              <p className={styles.action_desc}>
                Add, edit, or remove rooms and facilities in the Resource Service
              </p>
              <button className={styles.action_btn} style={{background:'#0284c7'}} onClick={onManageRooms}>
                Manage Rooms →
              </button>
            </div>
